...
WHERE id IN ('ListAuthRoles', 'CreateAuthRole', 'GetAuthRole', 'UpdateAuthRole', 'DeleteAuthRole', 'ListAuthRoleContractApis', 'CreateAuthRoleContractApi', 'DeleteAuthRoleContractApi', 'AssignAuthUserRole', 'DeleteAuthUserRole');
