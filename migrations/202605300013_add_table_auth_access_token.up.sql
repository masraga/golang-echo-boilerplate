CREATE TABLE IF NOT EXISTS public.auth_access_token (
...
COMMENT ON COLUMN public.auth_access_token.id IS 'JWT access token';

COMMENT ON COLUMN public.auth_access_token.user_id IS 'Auth user id';
